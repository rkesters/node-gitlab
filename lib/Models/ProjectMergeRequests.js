(function() {
  ...
  ProjectMergeRequests = (function(superClass) {
    ...
    function ProjectMergeRequests() {
      ...
      this.notes = bind(this.notes, this);
    ...
    ProjectMergeRequests.prototype.changes = function(projectId, mergerequestId, fn) {
      ...
      this.debug("Projects::changesMergeRequest(" + projectId + ", " + mergerequestId + ")");
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/merge_requests/" + (parseInt(mergerequestId)) + "/changes", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectMergeRequests.prototype.notes = function(projectId, mergerequestId, fn) {
      if (fn == null) {
        fn = null;
      }
      this.debug("Projects::notesMergeRequest(" + projectId + ", " + mergerequestId + ")");
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/merge_requests/" + (parseInt(mergerequestId)) + "/notes", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectMergeRequests.prototype.show = function(projectId, mergerequestId, fn) {
      ...
      this.debug("Projects::mergerequest(" + projectId + ", " + mergerequestId + ")");
